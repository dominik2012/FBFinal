...
class SiteController extends Controller
{
	 ...
	 public function accessRules()
	{
		return array(
			array('allow',  // just guest can perform 'activate', 'login' and 'passRequest' actions
				'actions'=>array('filter','login'),
				'ajax'=>false,
				'users'=>array('@'),
			),
			array('deny',  // deny all users
				'actions'=>array('site/contact'),
				'users'=>array('*'),
			),
			);
	}
	...
	public function actionFilter()
	{
		...
		$this->render('filter',array('model'=>$funktion, 'model3'=>$funktion, 'model2' =>$model2, 'model6' => $spaltennamen, 'model5' => $spaltennamen2, 'grobphase' => $grobphase,'gesetz2' => $gesetz2, 'funktionsfolgenArr' => $funktionsfolgenArr,'sprungstellenArr' => $sprungstellenArr, 'gesetze'=>$gesetze,'unterphase2'=>$unterphase2,));
		}
	}
